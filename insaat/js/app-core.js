...
function applyMenuText(){
  try{
    ...
    document.querySelectorAll('.insaatFooter').forEach(function(f){
      ...
      if(cols[2]){var _hh=en?['All Listings','For Sale','For Rent','Residential Construction','Urban Renewal','Turnkey']:['Tüm İlanlar','Satılık İlanlar','Kiralık İlanlar','Konut İnşaatı','Kentsel Dönüşüm','Anahtar Teslim'];cols[2].querySelectorAll('a').forEach(function(a,i){if(_hh[i])a.textContent=_hh[i];});}
...
const INSAAT_NAV=`<a href="hizmetlerimiz.html" onclick="return goPage('hizmetler',event)">Hizmetlerimiz</a>`
  ...
  +`<a href="#ozel" onclick="event.preventDefault();openIlanlarPage&&openIlanlarPage();setTimeout(function(){var e=document.querySelector('.ins-oz-section');if(e)e.scrollIntoView({behavior:'smooth'});},260)">Özel Portföy</a>`
...
const INSAAT_FOOTER=`<div class="wrap">
  <div class="fgrid">
    ...
    <div><h4>Hizmetler</h4><a href="ilanlar.html"><b>Tüm İlanlar</b></a><a href="ilanlar.html?op=Satılık">Satılık İlanlar</a><a href="ilanlar.html?op=Kiralık">Kiralık İlanlar</a><a href="hizmetlerimiz.html">Konut İnşaatı</a><a href="hizmetlerimiz.html">Kentsel Dönüşüm</a><a href="hizmetlerimiz.html">Anahtar Teslim</a></div>
    <div><h4>İletişim</h4>
