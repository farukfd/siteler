...
const INSAAT_FOOTER=`<div class="wrap">
  <div class="fgrid">
    ...
    <div><h4>Kurumsal</h4><a href="neden-biz.html">Hakkımızda</a><a href="#" onclick="closeAllInsaatOverlays();openDoc('vizyon');return false">Vizyon & Misyon</a><a href="#" onclick="closeAllInsaatOverlays();openDoc('yonetim');return false">Yönetim Kadrosu</a><a href="#" onclick="closeAllInsaatOverlays();openDoc('kalite');return false">Kalite & Sertifikalar</a><a href="#medya" onclick="return fGo('medya')">Medya & Basında Biz</a><a href="bolge.html">Bölge Ekspertizi</a><a href="#" onclick="closeAllInsaatOverlays();openDoc('kariyer');return false">Kariyer</a><a href="soru-cevap.html">İnşaata Başlamadan Dikkat Edilecekler</a></div>
    <div><h4>Hizmetler</h4><a href="hizmetlerimiz.html">Konut İnşaatı</a><a href="hizmetlerimiz.html">Tadilat & Renovasyon</a><a href="hizmetlerimiz.html">Kentsel Dönüşüm</a><a href="hizmetlerimiz.html">Kat Karşılığı</a><a href="hizmetlerimiz.html">Anahtar Teslim</a><a href="hizmetlerimiz.html">Ticari Yapılar</a></div>
    <div><h4>İletişim</h4>
