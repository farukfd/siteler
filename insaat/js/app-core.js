...
const INSAAT_FOOTER=`<div class="wrap">
  <div class="fgrid">
    ...
    <div><h4>Hizmetler</h4><a href="ilanlar.html"><b>Tüm İlanlar</b></a><a href="ilanlar.html?op=Satılık">Satılık İlanlar</a><a href="ilanlar.html?op=Kiralık">Kiralık İlanlar</a><a href="ozel-portfoy.html">🔒 Özel Portföy</a><a href="bolge.html">Bölge Zekası</a><a href="hizmetlerimiz.html">Konut İnşaatı</a><a href="hizmetlerimiz.html">Kentsel Dönüşüm</a><a href="hizmetlerimiz.html">Anahtar Teslim</a></div>
    <div><h4>İletişim</h4>
...
function insBoot(){
  ...
  try{if((location.hash||'')==='#medya'){var _md=function(){if(typeof fGo==='function')fGo('medya');else{var el=document.getElementById('medya');if(el)el.scrollIntoView({behavior:'smooth',block:'start'});}};if(document.readyState==='complete')setTimeout(_md,300);else window.addEventListener('load',function(){setTimeout(_md,300);});}}catch(e){}
}
