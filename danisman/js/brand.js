/* ===================================================================
   ...
   Yönetimi ADMİN panelinden yapılır; TÜM sayfalarda (SPA + statik) uygulanır.
   Depo: localStorage["dn_brand"] = { favicon:<dataURI|url>, googleLogo:<dataURI|url> }
   Bağımsız (app.js gerektirmez) — her sayfanın <head>'inde yüklenir.
   =================================================================== */
(function () {
  var KEY = "dn_brand";
  var DEFAULT_FAVICON = "favicon.svg"; // repo'daki varsayılan marka ikonu
  var ORG = { type: "RealEstateAgent", name: "Selin Meridyen · Lüks Konut & Özel Portföy Danışmanlığı" };
  ...
  /* ---- ADMİN API ---- */
  // Değerleri ayarla (data-URI veya URL) → kaydet + tüm sayfalara uygulanır
  ...
  // <input type=file> → data-URI okur → ayarlar ('favicon' | 'googleLogo')
