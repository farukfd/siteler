...
(function () {
  ...
  window.DEG_SOCIAL_DEF = { facebook:'https://facebook.com/meridyendegerleme', instagram:'https://instagram.com/meridyendegerleme', x:'https://x.com/meridyendegerleme', linkedin:'https://www.linkedin.com/company/meridyendegerleme', youtube:'https://www.youtube.com/@meridyendegerleme', nsosyal:'https://nsosyal.com' };
  function degApplySocial(){ try{
    var s={}; try{ s=degMerge(); }catch(e){ try{ s=degAdminLoad(); }catch(e2){} }
    var soc=s.social||{}, DEF=window.DEG_SOCIAL_DEF||{};
    var IC={
      facebook:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.5c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07Z"/></svg>',
      instagram:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.16c3.2 0 3.58.01 4.85.07 1.17.05 1.8.25 2.23.41.56.22.96.48 1.38.9.42.42.68.82.9 1.38.16.42.36 1.06.41 2.23.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.05 1.17-.25 1.8-.41 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.42.16-1.06.36-2.23.41-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-1.17-.05-1.8-.25-2.23-.41a3.7 3.7 0 0 1-1.38-.9 3.7 3.7 0 0 1-.9-1.38c-.16-.42-.36-1.06-.41-2.23C2.17 15.58 2.16 15.2 2.16 12s.01-3.58.07-4.85c.05-1.17.25-1.8.41-2.23.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.42-.16 1.06-.36 2.23-.41C8.42 2.17 8.8 2.16 12 2.16Zm0 3.24a6.6 6.6 0 1 0 0 13.2 6.6 6.6 0 0 0 0-13.2Zm0 10.89a4.29 4.29 0 1 1 0-8.58 4.29 4.29 0 0 1 0 8.58Zm6.86-11.15a1.54 1.54 0 1 1-3.08 0 1.54 1.54 0 0 1 3.08 0Z"/></svg>',
      x:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.65l-5.22-6.82-5.97 6.82H1.66l7.73-8.83L1.25 2.25h6.82l4.71 6.23 5.46-6.23Zm-1.16 17.52h1.83L7.01 4.13H5.05l12.03 15.64Z"/></svg>',
      linkedin:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.94 5a1.94 1.94 0 1 1-3.88 0 1.94 1.94 0 0 1 3.88 0ZM3.4 8.4h3.1V21H3.4V8.4Zm5.34 0h2.97v1.72h.04c.41-.78 1.42-1.6 2.93-1.6 3.13 0 3.71 2.06 3.71 4.74V21h-3.1v-5.55c0-1.32-.02-3.02-1.84-3.02-1.84 0-2.12 1.44-2.12 2.92V21h-3.1V8.4Z"/></svg>',
      youtube:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M23.5 6.5a3.02 3.02 0 0 0-2.12-2.14C19.5 3.85 12 3.85 12 3.85s-7.5 0-9.38.51A3.02 3.02 0 0 0 .5 6.5C0 8.4 0 12 0 12s0 3.6.5 5.5a3.02 3.02 0 0 0 2.12 2.14C4.5 20.15 12 20.15 12 20.15s7.5 0 9.38-.51a3.02 3.02 0 0 0 2.12-2.14C24 15.6 24 12 24 12s0-3.6-.5-5.5ZM9.6 15.6V8.4l6.24 3.6-6.24 3.6Z"/></svg>',
      nsosyal:'<svg viewBox="0 0 575 574" aria-hidden="true"><path d="M171.226 0.078125H0V573.751H171.226V0.078125Z"/><path d="M76.1875 0.0782019L191.016 300.603L275.573 520.404C289.183 552.162 326.104 573.751 367.482 573.751H501.631C538.082 573.751 574.142 535.579 574.142 494.748V0H402.917V323.053L398.458 311.632L278.858 0H76.1875V0.0782019Z"/></svg>'
    };
    var ORDER=['facebook','instagram','x','linkedin','youtube','nsosyal'];
    var LBL={facebook:'Facebook',instagram:'Instagram',x:'X',linkedin:'LinkedIn',youtube:'YouTube',nsosyal:'NEXT Sosyal'};
    if(!document.getElementById('deg-social-css')){ var st=document.createElement('style'); st.id='deg-social-css'; st.textContent='.ft .fsocial{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}.ft .fsocial a{width:34px;height:34px;border-radius:10px;display:inline-grid;place-items:center;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);color:#c7d2e3;transition:.2s ease;text-decoration:none}.ft .fsocial a:hover{background:var(--acc,#2f5bd0);border-color:transparent;color:#fff;transform:translateY(-2px)}.ft .fsocial svg{width:17px;height:17px;fill:currentColor;display:block}'; document.head.appendChild(st); }
    var col=document.querySelector('.ft .cols > div'); if(!col) return;
    var box=col.querySelector('.fsocial'); if(!box){ box=document.createElement('div'); box.className='fsocial'; col.appendChild(box); }
    var html=''; ORDER.forEach(function(k){ var u=(soc[k]!=null)?soc[k]:DEF[k]; if(!u) return; html+='<a href="'+u+'" target="_blank" rel="noopener noreferrer" aria-label="'+LBL[k]+'">'+IC[k]+'</a>'; });
    box.innerHTML=html;
  }catch(e){} }
  ...
  function degAdminHTML() {
    ...
    return '<div class="sta-ov" data-aclose="1"></div><div class="sta-card">'
      ...
      + '<div style="margin:16px 0 10px;border-top:1px solid rgba(255,255,255,.12);padding-top:14px"><b>Sosyal Medya</b><span class="sub" style="display:block;margin-top:2px">Footer alaninda logonun altinda gorunur. Bos birakilan ikon gizlenir.</span></div>'
      + '<div class="sta-row2"><div class="sta-f"><label>Facebook</label><input id="sc_facebook" value="' + val(so.facebook != null ? so.facebook : sd.facebook) + '" placeholder="https://facebook.com/..."></div><div class="sta-f"><label>Instagram</label><input id="sc_instagram" value="' + val(so.instagram != null ? so.instagram : sd.instagram) + '" placeholder="https://instagram.com/..."></div></div>'
      + '<div class="sta-row2"><div class="sta-f"><label>X (Twitter)</label><input id="sc_x" value="' + val(so.x != null ? so.x : sd.x) + '" placeholder="https://x.com/..."></div><div class="sta-f"><label>LinkedIn</label><input id="sc_linkedin" value="' + val(so.linkedin != null ? so.linkedin : sd.linkedin) + '" placeholder="https://linkedin.com/company/..."></div></div>'
      + '<div class="sta-row2"><div class="sta-f"><label>YouTube</label><input id="sc_youtube" value="' + val(so.youtube != null ? so.youtube : sd.youtube) + '" placeholder="https://youtube.com/@..."></div><div class="sta-f"><label>NEXT Sosyal</label><input id="sc_nsosyal" value="' + val(so.nsosyal != null ? so.nsosyal : sd.nsosyal) + '" placeholder="https://nsosyal.com/..."></div></div>'
  ...
  function ensureDegAdmin() {
    ...
    m.querySelector('#ct_btn').addEventListener('click', function () {
      ...
      s.social = { facebook: gv('sc_facebook'), instagram: gv('sc_instagram'), x: gv('sc_x'), linkedin: gv('sc_linkedin'), youtube: gv('sc_youtube'), nsosyal: gv('sc_nsosyal') };
      degAdminSaveStore(s);
  ...
  window.addEventListener('hashchange', function(){ if(/^#(yonetim|admin|panel)$/i.test(location.hash||'')){ try{ openDegAdmin(); }catch(e){} } });
  ...
  function degContactApply() {
    var c = (function(){try{return (degMerge()||{}).contact;}catch(e){return (degAdminLoad()||{}).contact;}})() || {};
  ...
  function degNedenBiz(){try{
    if(!document.getElementById('deg-nbx-css')){var st=document.createElement('style');st.id='deg-nbx-css';st.textContent='.nb-x{display:inline-flex;align-items:center;justify-content:center;width:1.35em;height:1.35em;background:#16a34a;color:#08130a;border-radius:6px;font-weight:800;font-size:.82em;line-height:1;vertical-align:middle;position:relative;top:-1px;margin:0 3px}';document.head.appendChild(st);}
    var lang='tr'; try{lang=localStorage.getItem('deg_lang')||'tr';}catch(e){}
    var links=document.querySelectorAll('nav a[href="neden-biz.html"], .mnav a[href="neden-biz.html"]');
    links.forEach(function(a){var tg=a.querySelector(':scope > span:not(.nb-x)')||a;
      if(!a.getAttribute('data-nbtr')){var o=(tg.textContent||'').replace(/[?]/g,'').replace(/\s+/g,' ').trim();if(o)a.setAttribute('data-nbtr',o);}
      var trL=a.getAttribute('data-nbtr')||'Neden Biz', label=trL;
      if(lang!=='tr'){try{var D=(typeof _i18n!=='undefined')?_i18n[lang]:null;if(D&&D[trL])label=D[trL];}catch(e){}}
      var p=label.split(/\s+/);
      var html=(p.length>=2)?(p[0]+' <span class="nb-x">?</span> '+p.slice(1).join(' ')):(label+' <span class="nb-x">?</span>');
      if(tg.getAttribute('data-nbhtml')!==html){tg.innerHTML=html;tg.setAttribute('data-nbhtml',html);}
    });
    if(!window._degNbHook){window._degNbHook=1;
      try{var o1=window.degSetLang;if(typeof o1==='function'){window.degSetLang=function(l){o1(l);[80,300,700].forEach(function(ms){setTimeout(degNedenBiz,ms);});};}}catch(e){}
      document.addEventListener('change',function(e){if(e.target&&e.target.classList&&e.target.classList.contains('lang-sel')){[80,300,700].forEach(function(ms){setTimeout(degNedenBiz,ms);});}});
    }
  }catch(e){}}
  function degMobileNav() {
    ...
    try{ var _da=degAdminLoad(); var _wn=((_da.contact&&_da.contact.whatsapp)||'').replace(/[^0-9]/g,''); if(_wn) WA='https://wa.me/'+_wn; }catch(e){}
  ...
  function degRunInit() {
    try { degApplySettings(); degApplyApiKeys(); degApplySeo(); degApplyLogo(); degSpkApply(); degMobileNav(); degApplyWhatsApp(); degApplySocial(); degCookieBar(); degI18nInit(); degNedenBiz(); degInitReveal(); degInitCount(); degHeroAnim(); degIndexBand(); degContactInit(); degLegalApply(); degContentApply(); degBlogPageInit(); degSikayetInit(); try{ if(/^#(yonetim|admin|panel)$/i.test(location.hash||'')) openDegAdmin(); }catch(_e){} } catch (e) {}
  }
