...
(function(){
  ...
  function _css(){
    ...
    +'.lp-seg button{border:0;background:transparent;color:'+MUT+';font:600 13px/1 system-ui,-apple-system,sans-serif;padding:9px 14px;border-radius:9px;cursor:pointer;transition:.15s;white-space:nowrap}'
    ...
    +'.lp-clear{margin-left:auto;border:1px solid '+LINE+';background:'+SURF+';color:'+MUT+';border-radius:8px;padding:7px 12px;font:600 12px/1 system-ui;cursor:pointer}'
    ...
    +'.lp-empty-ic{font-size:44px;margin-bottom:10px}'
    +'.lp-empty h3{color:'+INK+';font:700 20px/1.3 system-ui,-apple-system,sans-serif;margin:0 0 8px}'
    +'.lp-empty p{max-width:520px;margin:0 auto 18px;font:500 14px/1.6 system-ui}'
    +'.lp-empty em{color:'+A+';font-style:normal;font-weight:700}'
    +'.lp-empty-btn{border:0;background:'+A+';color:#fff;border-radius:11px;padding:12px 22px;font:700 14px/1 system-ui;cursor:pointer}'
