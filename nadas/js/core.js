...
(function () {
  ...
  function Footer() {
    ...
    var col3 = [["White-label Web", "white-label.html"], ["Web Yazılım", "web-yazilim.html"], ["Kurumsal API", "kurumsal-api.html"], ["CRM Çözümleri", "crm.html"], ["Veri Lisansı", "veri-lisansi.html"], ["Teklif Al", "iletisim.html#teklif"]]
      .map(function (x) { return '<a href="' + x[1] + '" style="' + css({ display: "block", fontFamily: C.mono, fontSize: 11, color: C.textMut, textDecoration: "none", padding: "3px 0", letterSpacing: "0.04em" }) + '">' + x[0] + '</a>'; }).join("");
